    ...
    <html data-theme="light" class="bg-background">
        ...
        <body class="min-h-screen flex flex-col">
            ...
            <main class="w-[90%] mx-auto mt-6 max-w-5xl mb-4" data-aos="fade-up" data-aos-duration="1000">
                ...
                <form action="proses_report.php" method="POST" enctype="multipart/form-data" class=" bg-white p-6 rounded-lg shadow border border-black">
                    <?php
                        ...
                        <div class="flex flex-col md:flex-row gap-4 flex-1">
                            <div class="flex-1">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="deskripsi" required rows="4" class="textarea border textarea-bordered w-full" required></textarea>
                                </div>
                                <div class="mb-4">
                                    <label class="block font-semibold mb-1">Uploud Proof</label>
            ...
            <script>
                ...
                const tanggal = document.querySelector("input[name='tanggal_report']").value.trim();
                const kategori = document.querySelector("select[name='kategori_report']").value.trim();
