...
<body class="min-h-screen flex flex-col">
    ...
    <main class="w-[90%] mx-auto mt-6 max-w-5xl mb-4" data-aos="fade-up" data-aos-duration="1000">
        ...
        <form action="proses_report.php" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow border border-gray-200">
            <?php
            ...
            <div class="flex flex-col md:flex-row gap-6">
                <div class="flex-1">
                    <div class="mb-4">
                        ...
                        <input type="text" disabled value="<?= htmlspecialchars($data['nama_kantin']) ?>" class="input input-bordered w-full" />
                    </div>
                    <div class="mb-4">
                        <label class="block font-semibold mb-1">Canteen ID</label>
                        <input type="text" disabled value="<?= htmlspecialchars($id_per_penjual) ?>" class="input input-bordered w-full" />
                    </div>
                    <div class="mb-4">
    ...
    <script>
        ...
        // Optional form validation (in case user bypasses HTML5 required)
