...
if (isset($_POST['submit'])) {
    ...
    $result = verification_account_reset_password($koneksi, $kode_otp_masuk, $id_user);

    if ($result) {
    header("Location: reset_password.php?success=true&id_user=" . $id_user);
    exit();
    } else {
...
<body class="min-h-screen flex flex-col">
  ...
  <div class="flex justify-center items-center flex-1">
    ...
    <p class="mt-4 text-center text-sm text-gray-600">
        ...
        <a href="verif-otp-reset.php?resend=true" class="text-yellow-600 hover:underline">Resend OTP</a>
    </p>
    </div>
  </div>
