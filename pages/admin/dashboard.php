  ...
  <main class="w-[90%] mx-auto mt-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-2 gap-2 mb-2">
      <div class="bg-white border border-black rounded-lg p-4 text-center shadow">
        ...
        <p class="text-2xl font-bold text-kuning">120</p>
      </div>
      <div class="bg-white border border-black rounded-lg p-4 text-center shadow">
        <h3 class="text-lg font-semibold">Total Penjual</h3>
        <p class="text-2xl font-bold text-kuning">25</p>
      </div>
    </div>

    <!-- Navigasi Kelola -->
    <div class="grid grid-cols-2 md:grid-cols-2 gap-2">
      <a href="kelola_pembeli.php" class="bg-white border border-black rounded-lg p-4 text-center hover:bg-gray-100 transition">
