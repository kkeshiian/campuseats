...
<body class="min-h-screen flex flex-col">
  ...
  <main class="w-[90%] mx-auto mt-6">
    ...
    <form method="POST" class="space-y-4 bg-white p-6 rounded-lg shadow border">
        ...
        <!-- Penjual Name -->
        <div>
          <label class="block font-semibold mb-1">Username Penjual</label>
          <input type="text" name="username" value="" class="input input-bordered w-full" required />
        </div>

        <!-- password -->
        <div>
          <label class="block font-semibold mb-1">Change Password Penjual</label>
        ...
        <!-- Button -->
         <div class="flex ">
            ...
            <div class="flex justify-end">
                <button type="button" onclick="window.location.href='kelola_kantin.php?id_admin=<?= $id_admin ?>'" class="btn bg-kuning text-white hover:bg-yellow-600"><--Back</button>
            </div>
